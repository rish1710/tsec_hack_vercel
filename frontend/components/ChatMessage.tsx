          ...
          <div className="mt-3 pt-3 border-t border-slate-600">
            ...
            <div className="grid grid-cols-2 gap-2 text-xs">
              <div>
                ...
                <p className="font-semibold">{message.sessionRecommendation.estimatedMinutes} min</p>
              </div>
              <div>
                <span className="opacity-75">Cost:</span>
                <p className="font-semibold">${message.sessionRecommendation.totalEstimatedCost.toFixed(2)}</p>
              </div>
              <div className="col-span-2">
                <span className="opacity-75">Instructor:</span>
                <p className="font-semibold">{message.sessionRecommendation.instructorName}</p>
              </div>
            </div>
